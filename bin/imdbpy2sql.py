...
import os
import sys
sys.path.append(r'D:\JOBcode')
sys.path.append(r'D:\JOBcode\imdb')
sys.path.append(r'D:\JOBcode\imdb\parser')
sys.path.append(r'D:\JOBcode\imdb\parser\sql')
sys.path.append(r'D:\JOBcode\imdb\parser\sql\dbschema')
import getopt
import time
import re
import warnings
...
try:
    optlist, args = getopt.getopt(sys.argv[1:], 'u:d:e:o:c:i:h',['uri=', 'data=', 'execute=','mysql-innodb', 'ms-sqlserver','sqlite-transactions','fix-old-style-titles','mysql-force-myisam', 'orm','csv-only-write','csv-only-load','csv=', 'csv-ext=','imdbids=', 'help'])
